...
dictionary = joblib.load( open("../final_project/final_project_dataset.pkl", "rb") )
...
r_s = reg.score(feature_test, target_test)
print("R squared: ", r_s)
